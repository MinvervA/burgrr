        ...
        <div className="w-[20%]">
          ...
          <div className="flex flex-col gap-5 mt-5 overflow-auto h-[730px]">
            <div className="flex justify-center">
              <Button
                style={`btn bg-green-900 hover:bg-green-900 text-bold text-xl w-[200px] h-[80px] text-white rounded-full`}
                text="Add new +"
              />
            </div>
        ...
        <div className=" w-full border border-white border-l-green-600">
          <div className=" flex gap-5 justify-between border border-white border-b-green-600 pt-5 pb-5 px-10">
            ...
            <div className="flex gap-2">
              ...
              <Searchbar />
              <Button
                style="btn bg-green-600 hover:bg-green-600 text-white w-[80px]"
                text="Search"
              />
          ...
          <div className="grid grid-cols-4 gap-5 p-5 h-[600px] overflow-auto w-full">
            <ProductCard
              ...
              button={
                <Button
                  style="btn bg-green-600 text-white hover:text-white hover:bg-green-600 rounded-full"
                  text="edit"
                />
              }
            />
            <ProductCard
              name="Double Cheese Burgrr"
              button={
                <Button
                  style="btn bg-green-600 text-white hover:text-white hover:bg-green-600 rounded-full"
                  text="edit"
